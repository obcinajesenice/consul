section "Creating Tags Categories" do
  ...
  ActsAsTaggableOn::Tag.category.create!(name: I18n.t('seeds.categories.free_time'))
  ActsAsTaggableOn::Tag.category.create!(name: I18n.t('seeds.categories.sustainable_development'))
  ActsAsTaggableOn::Tag.category.create!(name: I18n.t('seeds.categories.young'))
  ActsAsTaggableOn::Tag.category.create!(name: I18n.t('seeds.categories.political_participation'))
  ActsAsTaggableOn::Tag.category.create!(name: I18n.t('seeds.categories.nature'))
end
